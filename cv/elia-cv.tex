...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItem{Administered Linux clusters supporting experimental distributed systems.}
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
    \textbf{Languages Spoken}{: Portuguese (native), English (fluent), Italian (intermediate)} \\ \vspace{2mm}
     \textbf{Languages}{: Java, JavaScript, HTML/CSS, C/C++, SQL (SQL Server), Go, PHP, Visual Basic} \\ \vspace{2mm}
     \textbf{Frameworks, Methodologies \& Libraries}{: React, Node.js, React Native, Next.js, Typescript, Material-UI, Express.js, Agile, SCRUM} \\ \vspace{2mm}
     \textbf{Developer Tools \& Platforms}{: Git (Github, Gitlab, Bitbucket), Maven, Gradle, REST APIs, VS Code, Visual Studio, IntelliJ, Eclipse, Postman, Swagger} \\ \vspace{2mm}
     \textbf{Databases \& Storage}{: SQL Server, PostgreSQL, Firebase Realtime Database, Firestore} \\ \vspace{2mm}
     ...
     \textbf{Distributed Systems}{: State Machine Replication, Atomic Broadcast, BFTSMaRt, Paxos} \\ \vspace{2mm}
