...
\resumeSubheading
  ...
  \small
  \justifying
  Software engineer and researcher with over \textbf{15 years} of experience designing and implementing high-performance software and fault-tolerant systems. Currently a \textbf{\textsc{Ph.D.} candidate} and researcher at Università della Svizzera Italiana (\textsc{USI}) in Lugano, Switzerland, specializing in distributed systems. Proficient in \textbf{Java}, \textbf{Node.js}, \textbf{Go} and \textbf{Python} for back-end development, and skilled in \textbf{ReactJS}, \textbf{Next.js} , and \textbf{React Native} for front-end and mobile applications. Experienced in \textbf{Linux environments}, \textbf{system optimization}, and \textbf{leading development teams}. Passionate about building robust systems that connect cutting-edge engineering with real-world impact.
...
\section{Professional Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Researcher and Teaching Assistant}{2021 -- Present}
      {Università della Svizzera Italiana (USI)}{Lugano, Switzerland}
      \resumeItemListStart
      \resumeItem{Conducted \textbf{research and development} in distributed systems using \textbf{Java}, \textbf{Go}, \textbf{Python}, \textbf{C}, and \textbf{Bash} on \textbf{Linux} environments. Administered a \textbf{Linux cluster}, developed core replicated systems components focusing on \textbf{performance} and \textbf{fault tolerance}, and authored research papers for top distributed systems conferences. Also a \textbf{Teaching assistant} for Operating Systems, Systems Programming, and Distributed Algorithms courses.}
      \resumeItemListEnd
